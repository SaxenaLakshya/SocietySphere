...
- Look for some optimisations in **Login** and **Register** Page.
- Get started with the backend of the website for **Login** and **Register** functionalities.
- Added **Admin Register Form** and add functionalities to it.